...
public class DeckDebate2b : MonoBehaviour
{
    ...
    IEnumerator OpponentReply()
    {
        ...
        if (WhichOpponentReply == 1)
        {
            ...
            OpponentSpeech.text = "Dude, calm down we don't even live in America";
        ...
        if (WhichOpponentReply == 2)
        {
            ...
            OpponentSpeech.text = "Gun control laws would prevent citizens from protecting themselves from foreign invaders. ";
            yield return new WaitForSeconds(0.001f);
            AudienceMood = 5;
        }
        ...
        {
            PlayerAudienceApproval = PlayerAudienceApproval - 1;
            OpponentSpeech.text = "More gun control is not needed; education about guns and gun safety is needed to prevent accidental gun deaths. ";
            yield return new WaitForSeconds(0.001f);
            AudienceMood = 1;
        }
        ...
        {
            PlayerAudienceApproval = PlayerAudienceApproval + 1;
            OpponentSpeech.text = "It's there God given right!";
            yield return new WaitForSeconds(0.001f);
            AudienceMood = 2;
        }
        if (WhichOpponentReply == 5)
        {
            PlayerAudienceApproval = PlayerAudienceApproval - 0;
            OpponentSpeech.text = "Gun control laws such as background checks and micro-stamping are an invasion of privacy.";
            yield return new WaitForSeconds(0.001f);
            AudienceMood = 5;
        }
        if (WhichOpponentReply == 6)
        {
            ...
            OpponentSpeech.text = "Gun control laws, especially those that try to ban “assault weapons,” infringe upon the right to own guns for hunting and sport.";
            yield return new WaitForSeconds(0.001f);
            AudienceMood = 4;
        }
        ...
        {
            PlayerAudienceApproval = PlayerAudienceApproval - 1;
            OpponentSpeech.text = "Gun control laws infringe upon the right to self-defense and deny people a sense of safety. ";
            yield return new WaitForSeconds(0.001f);
            AudienceMood = 4;
        }
        ...
        {
            PlayerAudienceApproval = PlayerAudienceApproval - 1;
            OpponentSpeech.text = "A study in Applied Economics Letters found that assault weapons bans did not significantly affect murder rates at the state level and states with restrictions on the carrying of concealed weapons had higher gun-related murders.";
            yield return new WaitForSeconds(0.001f);
            AudienceMood = 5;
        }
        ...
        {
            PlayerAudienceApproval = PlayerAudienceApproval + 1;
            OpponentSpeech.text = "The Second Amendment of the US Constitution protects individual gun ownership.";
            yield return new WaitForSeconds(0.001f);
            AudienceMood = 3;
        }
        if (WhichOpponentReply == 10)
        {
            ...
            OpponentSpeech.text = "Gun control laws are racist. Current gun control laws are frequently aimed at inner city, poor, black communities who are perceived as more dangerous than white gun owners.";
            yield return new WaitForSeconds(0.001f);
            AudienceMood = 5;
        }
